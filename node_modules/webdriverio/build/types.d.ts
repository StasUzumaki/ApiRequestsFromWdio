...
declare type $BrowserCommands = typeof BrowserCommands;
declare type $ElementCommands = typeof ElementCommands;
...
declare type AsyncElementProto = {
...
export declare type BrowserCommandsType = Omit<$BrowserCommands, keyof ChainablePrototype> & ChainablePrototype;
export declare type ElementCommandsType = Omit<$ElementCommands, keyof ChainablePrototype> & ChainablePrototype;
export declare type BrowserCommandsTypeSync = {
    ...
    execute: <ReturnValue, InnerArguments extends any[] = any[], OuterArguments extends InnerArguments = any>(script: string | ((...innerArgs: OuterArguments) => ReturnValue), ...args: InnerArguments) => ReturnValue;
};
 ...
 */
declare type SingleElementCommandNames = '$' | 'custom$' | 'react$';
declare type MultiElementCommandNames = '$$' | 'custom$$' | 'react$$';
declare type ElementCommandNames = SingleElementCommandNames | MultiElementCommandNames;
declare type MultiRemoteElementCommands = {
...
declare type MultiRemoteElementCommandsSync = {
...
export declare type MultiRemoteBrowserCommandsType = {
...
export declare type MultiRemoteBrowserCommandsTypeSync = {
...
export declare type MultiRemoteElementCommandsType = {
...
export declare type MultiRemoteElementCommandsTypeSync = {
...
export declare type MultiRemoteProtocolCommandsType = {
...
export declare type MultiRemoteProtocolCommandsTypeSync = {
...
declare type OverwriteCommandFnScoped<ElementKey extends keyof $ElementCommands, BrowserKey extends keyof $BrowserCommands, IsElement extends boolean = false> = (this: IsElement extends true ? WebdriverIO.Element : WebdriverIO.Browser, origCommand: (...args: any[]) => IsElement extends true ? WebdriverIO.Element[ElementKey] : WebdriverIO.Browser[BrowserKey], ...args: any[]) => Promise<any>;
declare type OverwriteCommandFn<ElementKey extends keyof $ElementCommands, BrowserKey extends keyof $BrowserCommands, IsElement extends boolean = false> = (origCommand: (...args: any[]) => IsElement extends true ? WebdriverIO.Element[ElementKey] : WebdriverIO.Browser[BrowserKey], ...args: any[]) => Promise<any>;
export declare type CustomLocatorReturnValue = HTMLElement | HTMLElement[] | NodeListOf<HTMLElement>;
...
export declare type Browser<Mode extends 'sync' | 'async'> = Mode extends 'sync' ? BrowserSync : BrowserAsync;
...
export declare type Element<Mode extends 'sync' | 'async'> = Mode extends 'sync' ? ElementSync : ElementAsync;
...
declare type MultiRemoteBrowserReferenceAsync = Record<string, Browser<'async'>>;
declare type MultiRemoteBrowserReferenceSync = Record<string, Browser<'sync'>>;
declare type MultiRemoteElementReferenceAsync = Record<string, Element<'async'>>;
declare type MultiRemoteElementReferenceSync = Record<string, Element<'sync'>>;
...
export declare type MultiRemoteBrowser<Mode extends 'sync' | 'async'> = Mode extends 'sync' ? MultiRemoteBrowserReferenceSync & MultiRemoteBrowserSync : MultiRemoteBrowserReferenceAsync & MultiRemoteBrowserAsync;
export declare type MultiRemoteElement<Mode extends 'sync' | 'async'> = Mode extends 'sync' ? MultiRemoteElementReferenceSync & MultiRemoteElementSync : MultiRemoteElementReferenceAsync & MultiRemoteElementAsync;
